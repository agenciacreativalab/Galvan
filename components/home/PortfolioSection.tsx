        ...
        <div ref={marqueeRef} className="flex flex-nowrap w-max">
                    ...
                    <div className="flex shrink-0">
                      <div className="relative h-[200px] md:h-[450px] w-[800px] md:w-[1200px] shrink-0 mx-4">
                        <Image src="/bloque6/ELEMENTO 1.webp" alt="Work 1" fill className="object-contain" />
                      </div>
                      <div className="relative h-[200px] md:h-[450px] w-[800px] md:w-[1200px] shrink-0 mx-4">
                        <Image src="/bloque6/ELEMENTO 2.webp" alt="Work 2" fill className="object-contain" />
                      </div>
                      <div className="relative h-[200px] md:h-[450px] w-[800px] md:w-[1200px] shrink-0 mx-4">
                        <Image src="/bloque6/ELEMENTO 3.webp" alt="Work 3" fill className="object-contain" />
                      </div>
                    </div>
